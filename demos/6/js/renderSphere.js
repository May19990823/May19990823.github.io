...
var lightAmbient = vec4.fromValues(1.2, 1.2, 0.2, 1.0);
var lightDiffuse = vec4.fromValues(1.0, 1.0, 1.0, 1.0);
var lightSpecular = vec4.fromValues(0.0, 1.0, 1.0, 1.0);

var materialAmbient = vec4.fromValues(1.0, 1.0, 1.0, 1.0);
var materialDiffuse = vec4.fromValues(0.0, 1.0, 1.0, 1.0);
var materialSpecular = vec4.fromValues(1.0, 0.0, 1.0, 1.0);
var materialShininess = 100.0;

var clearColor = vec4.fromValues(0.5, 0.5, 0.5, 0.9);
